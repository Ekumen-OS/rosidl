...
#define ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_STRING_DECLARE(STRUCT_NAME, CHAR_TYPE) \
  ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING_DECLARE(STRUCT_NAME, CHAR_TYPE, 0U)
...
#define ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING_DEFINE(STRUCT_NAME, CHAR_TYPE, \
  ...
  { \
    ...
    if ((UPPER_BOUND) > 0U && _string->_impl.capacity > (size_t)(UPPER_BOUND)) { \
      _string->_impl.capacity = (size_t)(UPPER_BOUND); \
    } \
...
/// @brief Define basic basic string functions.
#define ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_STRING_DEFINE(STRUCT_NAME, CHAR_TYPE) \
  ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING_DEFINE(STRUCT_NAME, CHAR_TYPE, 0U)

/// @brief Convenience macro declaring and defining a bounded basic string in one place.
#define ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING(STRUCT_NAME, CHAR_TYPE, UPPER_BOUND) \
  ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING_DECLARE( \
    STRUCT_NAME, CHAR_TYPE, UPPER_BOUND) \
  ROSIDL_RUNTIME_C__EXPERIMENTAL__BASIC_BOUNDED_STRING_DEFINE(STRUCT_NAME, CHAR_TYPE, UPPER_BOUND)
