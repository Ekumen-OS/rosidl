...
def experimental_field_typename(
    ...
    Example: pkg__msg__experimental__Msg, foo, BasicType('float')  ->  pkg__msg__experimental__Msg__foo  # noqa: E501
    Example: pkg__msg__experimental__Msg, bar, NamespacedType(...)  ->  pkg__msg__experimental__Msg__bar  # noqa: E501
    """
...
def experimental_field_declare_macro(message_typename, member):
    ...
    if isinstance(type_, AbstractString):
        if type_.has_maximum_size():
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__BOUNDED_STRING_ALIAS({}, rosidl_runtime_c__experimental__BoundedString, char)'.format(  # noqa: E501
                field_tn
            )
        return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__STRING_ALIAS({}, rosidl_runtime_c__experimental__String, char)'.format(  # noqa: E501
            field_tn
        )

    if isinstance(type_, AbstractWString):
        if type_.has_maximum_size():
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__BOUNDED_STRING_ALIAS({}, rosidl_runtime_c__experimental__BoundedWString, char16_t)'.format(  # noqa: E501
                field_tn
            )
        return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__STRING_ALIAS({}, rosidl_runtime_c__experimental__WString, char16_t)'.format(  # noqa: E501
            field_tn
        )
    ...
    if isinstance(type_, BoundedSequence):
        ...
        if isinstance(vt, BasicType):
            ...
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__PRIMITIVE_BOUNDED_SEQUENCE_ALIAS({}, {}, {})'.format(  # noqa: E501
        ...
        if isinstance(vt, (AbstractString, AbstractWString)):
            if vt.has_maximum_size():
                ...
                return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__BOUNDED_ELEMENT_BOUNDED_SEQUENCE_DECLARE({}, {})'.format(  # noqa: E501
                    field_tn, elem_c
                )
            else:
    ...
    if isinstance(type_, UnboundedSequence):
        ...
        if isinstance(vt, AbstractString) and not vt.has_maximum_size():
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__SEQUENCE_ALIAS({}, rosidl_runtime_c__experimental__String__Sequence, rosidl_runtime_c__experimental__String)'.format(  # noqa: E501
                field_tn
            )
        if isinstance(vt, AbstractWString) and not vt.has_maximum_size():
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__SEQUENCE_ALIAS({}, rosidl_runtime_c__experimental__WString__Sequence, rosidl_runtime_c__experimental__WString)'.format(  # noqa: E501
                field_tn
            )
        if isinstance(vt, NamespacedType):
        ...
        elem_c = experimental_element_c_type(message_typename, member.name, vt)
        if isinstance(vt, AbstractString):
            return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__BOUNDED_ELEMENT_SEQUENCE_DECLARE({}, {})'.format(  # noqa: E501
                field_tn, elem_c
            )
    ...
    if isinstance(type_, BoundedSequence):
        ...
        if isinstance(vt, (AbstractString, AbstractWString)):
            if vt.has_maximum_size():
                ...
                elem_c = experimental_element_c_type(message_typename, member.name, vt)
                return 'ROSIDL_RUNTIME_C__EXPERIMENTAL__BOUNDED_ELEMENT_BOUNDED_SEQUENCE_DEFINE({}, {})'.format(  # noqa: E501
                    field_tn, elem_c
                )
            else:
